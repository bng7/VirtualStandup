...
btnAddMember.addEventListener('click', () => {
    ...
    fetch('http://3.24.27.105:8081/api/team', {
        method: 'POST',
...
btnAddProject.addEventListener('click', () => {
    ...
    fetch('http://3.24.27.105:8081/api/projects', {
        method: 'POST',
...
filter.addEventListener('change', (e) => {
    ...
    fetch(`http://3.24.27.105:8081/api/standup/${teamMember}`)
        .then(res => res.json())
        .then(res => {
            let notes = res.notes;
            populateNotes(notes);
...
function getNotes() {
    fetch('http://3.24.27.105:8081/api/standup')
        .then(res => res.json())
        .then(res => {
            let notes = res.notes;
            populateNotes(notes);
